        ...
        <section className="py-20 lg:py-32">
          <div className="container mx-auto text-center">
            ...
            <p className="text-muted-foreground mx-auto mb-8 max-w-2xl text-lg">
              ArcLMS was founded with a simple mission: to provide Nigerian primary and secondary schools with
              world-class learning management tools that are affordable, reliable, and easy to use.
            </p>
          </div>
        </section>
          ...
          <div className="container mx-auto">
            <div className="mx-auto max-w-3xl">
              ...
              <div className="text-muted-foreground space-y-4">
                <p>
                  ArcLMS started in 2023 when our founders, experienced educators and technologists, noticed a gap in
                  the Nigerian education technology landscape. While global LMS platforms existed, none were tailored to
                  the specific needs of Nigerian schools — from the academic calendar structure to local payment
                  methods.
                </p>
                <p>
                  We built ArcLMS from the ground up to serve Nigerian primary and secondary schools. Our platform
                  understands Sessions and Terms, supports Nigerian class structures from Primary 1 to SS3, and
                  integrates with local payment providers like Paystack.
                </p>
                <p>
