    ...
    <main className="bg-background">
      <section className="border-b py-20">
        <div className="container mx-auto">
          <div className="mx-auto max-w-2xl text-center">
            <h1 className="text-foreground mb-6 text-4xl font-bold tracking-tight sm:text-5xl">Documentation</h1>
      ...
      <section className="bg-muted/30 border-t py-16">
        <div className="container mx-auto text-center">
          <h2 className="text-foreground mb-4 text-2xl font-bold">Looking for API Documentation?</h2>
