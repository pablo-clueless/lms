  ...
  return (
    <main className="bg-background">
      ...
      <section className="bg-muted/30 border-y py-20">
        <div className="container mx-auto">
          <h2 className="text-foreground mb-12 text-center text-2xl font-bold">Features for Primary Schools</h2>
      ...
      <section className="py-20">
        <div className="container mx-auto text-center">
          <h2 className="text-foreground mb-4 text-2xl font-bold">Transform Your Primary School</h2>
