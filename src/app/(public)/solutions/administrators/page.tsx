  ...
  return (
    <main className="bg-background">
      ...
      <section className="bg-muted/30 border-y py-20">
        <div className="container mx-auto">
          <h2 className="text-foreground mb-12 text-center text-2xl font-bold">Administrative Features</h2>
      ...
      <section className="py-20">
        <div className="container mx-auto text-center">
          <h2 className="text-foreground mb-4 text-2xl font-bold">Ready to Streamline Your Operations?</h2>
