...
const breadcrumbs = [{ label: "Communications", href: "/admin/communications" }];
    ...
    <div className="space-y-6 p-6">
      ...
      <div className="flex w-full items-center justify-between">
        <div className="w-fit space-y-1">
          <h3 className="text-3xl">Communications</h3>
          <p className="text-sm font-medium text-gray-600">Manage emails and announcements</p>
        </div>
      ...
      <div className="w-full space-y-4">
        <DataTable columns={emailColumns} data={data?.emails || []} />
      </div>
    </div>
  );
};
