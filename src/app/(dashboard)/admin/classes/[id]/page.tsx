...
import { RefreshIcon, UserGroupIcon, BookOpen01Icon } from "@hugeicons/core-free-icons";
...
const Page = () => {
  ...
  const breadcrumbs = [
    ...
    { label: classData?.name || "Class Details", href: `/admin/classes/${id}` },
  ];
      ...
      <div className="flex w-full items-center justify-between">
        <div className="space-y-1">
          <div className="flex items-center gap-3">
            <h3 className="text-2xl font-semibold">{classData?.name}</h3>
      ...
      <div className="w-full space-y-4">
            ...
            <div className="space-y-4 rounded-lg border p-4">
              ...
              <div className="space-y-3 text-sm">
                ...
                <div className="flex justify-between">
                  ...
                  <span>{classData?.arm || "N/A"}</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-muted-foreground">Level</span>
                  <span className="capitalize">{classData?.level?.toLowerCase()}</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-muted-foreground">Capacity</span>
                  <span>{classData?.capacity || "Unlimited"}</span>
                </div>
                <div className="flex justify-between">
        ...
        <TabPanel selected={currentTab} value="students">
          {studentsPending ? (
            ...
            <div className="space-y-4">
              <DataTable columns={studentColumns("ADMIN")} data={studentsData?.users || []} />
              <Pagination
