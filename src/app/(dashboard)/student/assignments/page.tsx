...
import { RefreshIcon, Task01Icon } from "@hugeicons/core-free-icons";
...
const Page = () => {
  ...
  const { data, isFetching, isPending, refetch } = useGetAssignments(courseId, values);
    ...
    <div className="space-y-6 p-6">
      ...
      <div className="space-y-4">
        {!courseId ? (
          ...
          <>
            <DataTable columns={assignmentColumns("STUDENT")} data={data?.data || []} />
            {data?.pagination && (
              <Pagination
