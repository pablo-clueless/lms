...
const breadcrumbs = [{ label: "Timetable", href: "/student/timetable" }];
    ...
    <div className="space-y-6 p-6">
      ...
      <div className="flex w-full items-center justify-between">
        <div className="w-fit space-y-1">
          ...
          <p className="text-sm font-medium text-gray-600">View your class schedule and upcoming periods</p>
        </div>
      ...
      <div className="w-full space-y-4">
        <DataTable columns={timetableColumns("STUDENT")} data={data?.data || []} />
      </div>
    </div>
  );
};
