...
import { notificationColumns } from "@/config/columns";
import { Button } from "@/components/ui/button";
import { useHandler } from "@/hooks";
import { cn } from "@/lib";

const breadcrumbs = [{ label: "Notifications", href: "/student/notifications" }];
...
const Page = () => {
  ...
  const { data, isFetching, isPending, refetch } = useGetNotifications(values);
    ...
    <div className="space-y-6 p-6">
      ...
      <div className="flex w-full items-center justify-between">
        <div className="w-fit space-y-1">
          ...
          <p className="text-sm font-medium text-gray-600">View your notifications and important updates</p>
        </div>
