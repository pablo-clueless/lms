...
const breadcrumbs = [{ label: "Courses", href: "/tutor/courses" }];
...
const Page = () => {
  ...
  const columns = createCourseColumns("TUTOR");
    ...
    <div className="space-y-6 p-6">
      ...
      <div className="flex w-full items-center justify-between">
        <div className="">
          ...
          <p className="text-sm text-neutral-600">View and manage your assigned courses</p>
        </div>
