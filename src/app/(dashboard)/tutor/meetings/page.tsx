...
const breadcrumbs = [{ label: "Meetings", href: "/tutor/meetings" }];
    ...
    <div className="space-y-6 p-6">
      ...
      <div className="flex w-full items-center justify-between">
        <div className="w-fit space-y-1">
          <h3 className="text-foreground text-3xl">Meetings</h3>
          <p className="text-sm font-medium text-gray-600">Schedule and manage virtual meetings for your classes</p>
        </div>
      ...
      <div className="w-full space-y-4">
        <DataTable columns={meetingColumns} data={data?.meetings || []} />
      </div>
    </div>
  );
};
