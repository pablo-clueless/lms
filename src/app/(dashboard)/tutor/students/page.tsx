...
const Page = () => {
  ...
  const columns = createAdminColumns("TUTOR");
  ...
  return (
    <div className="space-y-6 p-6">
      ...
      <div className="flex w-full items-center justify-between">
        <div className="">
          <h3 className="text-foreground text-3xl">My Students</h3>
          <p className="text-sm text-neutral-600">View students enrolled in your courses</p>
        </div>
